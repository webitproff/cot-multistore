...
$itemadd_array = [
	...
	'MSTOREADD_FORM_CAT_S2' => cot_mstore_selectbox_structure_select2('mstore', $ritem['msitem_cat'], 'rmsitemcat'),
	'MSTOREADD_FORM_CAT_SHORT_S2' => cot_mstore_selectbox_structure_select2('mstore', $ritem['msitem_cat'], 'rmsitemcat', $c),
	...
	'MSTOREADD_FORM_COSTDFLT' => cot_inputbox('text', 'rmsitemcostdflt', $ritem['msitem_costdflt'], 'size="10"'),
];
