...
if ($useCfgMstoreFromLang === true) {
    ...
    $cfg['mstore']['mstorelist_default_desc'] = '<span class="badge text-bg-primary">CMS</span>, <span class="badge text-bg-success">Скрипт</span> та <span class="badge text-bg-info">Движок</span> - вебсайт оптового інтернет-магазину для дропшипінгу та роздрібної торгівлі. Різні ціни в різних валютах на товари, створити вітрину товарів для оптових постачальників';
