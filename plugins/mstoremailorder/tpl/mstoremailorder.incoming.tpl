<!-- 
/**
 * MStore Email Order plugin: Страница списка входящих заказов
 * Filename: mstoremailorder.incoming.tpl
	...
	<nav aria-label="breadcrumb">
		<div class="ps-container-breadcrumb">
			<ol class="breadcrumb d-flex mb-0">
				...
				<li class="breadcrumb-item active">{PHP.L.mstoremailorder_incoming_orders}</li>
			</ol>
		</div>
	</nav>
</div>
<div class="min-vh-50 px-2 py-4">
	<div class="px-0 m-0 row justify-content-center">
		<div class="col-12 container-3xl">
			<h2 class="mb-4">{PHP.L.mstoremailorder_incoming_orders}</h2>
			...
			<form action="{FORM_URL}" method="get" class="mb-4">
				...
				<input type="hidden" name="m" value="incoming" />
				<div class="row g-3 align-items-end">
					<div class="col-md-4">
						...
						<select id="filter_status" name="filter_status" class="form-select">
							...
							<option value="0" {FILTER_STATUS_1_SELECTED}>{PHP.L.mstoremailorder_status_new}</option>
				...
				<table class="table table-striped table-hover">
					<thead class="table-light">
						<tr>
							...
							<th scope="col">{PHP.L.mstoremailorder_phone}</th>
			...
			<!-- ELSE -->
			<p class="text-muted">{PHP.L.mstoremailorder_no_incoming_orders}</p>
			<!-- ENDIF -->
			<!-- IF {PAGINATION} -->
