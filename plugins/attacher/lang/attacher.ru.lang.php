...
$L['info_desc'] = 'Загрузка изображений и файлов. Прикрепление файлов, генерация разных размеров и обработка «налету» изображений в статьях, вставка в визуальный редактор';
...
$L['att_add_pict_files'] = 'Изображения и файлы';
