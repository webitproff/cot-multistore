...
folder=01:string::attacher:Directory for files
prefix=02:string::att_:File prefix
exts=03:text::gif,jpg,jpeg,png,webp,zip,rar,7z,mp3,txt,md:Allowed extensions (comma separated, no dots and spaces)
items=04:string::8:Default attachments count per post (max.), 0 - unlimited
chunkSize=05:string::9194304:Chunk size (in bytes) (0 - Disable chunked file uploads)
accept=05:text:::Accepted MIME types in file selection dialog, comma separated. Empty means all types.
filesize=06:string::9194304:Max file size in bytes
