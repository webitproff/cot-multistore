...
<div class="border-bottom border-secondary py-3 px-3">
  <nav aria-label="breadcrumb">
    <div class="ps-container-breadcrumb">
      <ol class="breadcrumb d-flex mb-0"> {PRD_TITLE} </ol>
    </div>
  </nav>
</div>
  ...
  <div class="row justify-content-center">
    <div class="col-12 col-xxl-10">
      <div class="row mb-4 g-2 justify-content-center">
        ...
        <div class="col-md-4 col-lg-2 col-12 text-center">
          <!-- IF {PRD_COST} > 0 -->
          <span class="h4 text-success fw-bold">{PRD_COST} {PHP.cfg.payments.valuta}</span>
          <!-- ENDIF -->
        </div>
      </div>
      <!-- IF {PRD_STATE} == 2 -->
      ...
      <div class="row">
        <div class="col-12 col-lg-8 mx-auto pb-5">
          <div class="mb-4">
            ...
            <!-- IF {PRD_ID|att_count('market', $this, '', 'images')} > 0 -->
            <div class="mb-5"> {PRD_ID|att_display('market', $this, '', 'attacher.gallery.fancybox.market')} </div>
            <!-- ELSE -->
