  ...
  <div class="container-xl min-height-50vh">
    ...
    <div class="tabs">
      <ul class="nav nav-tabs mb-3">
        ...
        <li class="nav-item">
          <a class="nav-link<!-- IF {PHP.tab} == 'mstore' --> active<!-- ENDIF -->" href="{USERS_DETAILS_MSTORE_URL}#tab_mstore" data-bs-toggle="tab" role="tab">{PHP.L.mstore_user_products} {USERS_DETAILS_MSTORE_COUNT}</a>
        </li>
        <!-- ENDIF -->
...
<!-- IF {PHP|cot_module_active('pm')} -->
    ...
    <!-- Кнопка для авторизованных (отправить ЛС) -->
    <a href="{PHP.id|cot_url('pm','m=send&to=$this', '', 1)}"
    ...
    <!-- ELSE -->
        ...
        <!-- Кнопка для себя (входящие) -->
        <a href="{PHP|cot_url('pm')}"
           class="btn btn-outline-success"
           data-bs-toggle="tooltip"
           data-bs-placement="top"
           title="{PHP.L.pm_inbox}">
            <i class="fa-regular fa-envelope"></i>
            <span>{PHP.L.pm_inbox}</span>
        </a>
        <!-- ENDIF -->
...
<!-- ENDIF -->
        ...
        <div class="tab-pane fade<!-- IF {PHP.tab} == 'mstore' --> show active<!-- ENDIF -->" id="tab_mstore" role="tabpanel">
          {MSTORE}
        </div>
