...
<ul<!-- IF {LEVEL} == 0 --> class="nav flex-column"<!-- ELSE --> class="nav flex-column ps-3"<!-- ENDIF -->>
	<!-- IF {LEVEL} == 0 -->
	<li class="nav-item">
		<div class="p-2 mt-1" title="{PHP.L.All}">
			
			<a class="nav-link d-flex align-items-center" href="{PHP|cot_url('mstore')}"><i class="fa-solid fa-store fa-xl me-2"></i><span>{PHP.L.mstore_Mstore} {PHP.L.All}</span>
