  ...
  <nav aria-label="breadcrumb">
    <div class="ps-container-breadcrumb">
      <ol class="breadcrumb d-flex mb-0">
        <li class="breadcrumb-item active">{PHP.L.projects_edit_project_title}</li>
      </ol>
    </div>
  </nav>
</div>
...
<div class="min-vh-50 px-2 px-md-3 py-5">
  <div class="row justify-content-center">
    <div class="col-12 col-lg-10">
      ...
      <form action="{PRJEDIT_FORM_SEND}" method="post" name="editproj" enctype="multipart/form-data" class="needs-validation" novalidate>
        <div class="card shadow-sm">
          <div class="card-header">
            <h5 class="mb-0">{PHP.L.projects_edit_project_title}</h5>
          </div>
