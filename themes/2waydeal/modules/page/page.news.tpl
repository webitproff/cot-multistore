...
<div class="border-bottom border-secondary py-3 px-3">
  <nav aria-label="breadcrumb">
    <div class="ps-container-breadcrumb">
      <ol class="breadcrumb d-flex mb-0"> {PAGE_BREADCRUMBS} </ol>
    </div>
  </nav>
</div>
<div class="min-vh-50 px-2 px-md-3 py-4">
  <div class="row justify-content-center">
    <div class="col-12 col-md-10 col-xl-10 mx-0 px-0"> 
      ...
      <div class="row pt-5">
        <div class="col-12 col-md-8 mx-auto pb-5">
            ...
            <div class="card-body">
              <div class="row g-3 mb-3">
                ...
                <div class="col-12 col-md-6 text-md-end">
                  <strong>{PHP.L.Filedunder}:</strong> {PAGE_CAT_PATH_SHORT}
                </div>
              </div>
              <div class="mb-3"> 
			  {PAGE_TEXT} 
          ...
          <div class="mb-4" data-att-downloads="download">
            <h5>{PHP.L.att_attachments} {PHP.L.att_downloads}</h5> {PAGE_ID|att_downloads('page',$this)}
          </div>
          <!-- ENDIF -->
          <!-- ENDIF -->
        ...
        <div class="col-12 col-md-4 mx-auto">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body"> {PAGE_MULTI_TABTITLES} <p class="mb-0">{PAGE_MULTI_TABNAV}</p>
            </div>
          </div>
          <!-- END: PAGE_MULTI -->
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <ul class="list-group list-group-flush">
                ...
                <!-- IF {PAGE_CREATED} -->
                <li class="list-group-item px-0">
                  <strong>{PHP.L.2wd_page_published}</strong> {PAGE_CREATED}
                </li>
                <!-- ENDIF -->
                <!-- IF {PAGE_UPDATED} -->
                <li class="list-group-item px-0">
                  <strong>{PHP.L.2wd_page_latest_update}</strong> {PAGE_UPDATED}
                </li>
                <!-- ENDIF -->
