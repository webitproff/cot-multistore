...
if ($useCfgFromLang === true) {
    ...
    // Описание сайта
    $cfg['subtitle'] = 'Платформа для оптового интернет-магазина с каталогом товаров поставщиков по модели дропшиппинга, скачать бесплатно скрипт';
}

$cot_groups['7']['name'] = 'Покупатели';
$cot_groups['4']['name'] = 'Поставщики и продавцы';
