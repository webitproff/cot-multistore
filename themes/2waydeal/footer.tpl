<!-- BEGIN: FOOTER -->
        ...
        <div class="row g-3 justify-content-md-end justify-content-center">
          ...
          <div class="col-md-6 col-12 text-center">
            <a href="https://github.com/Cotonti/Cotonti" target="_blank" class="text-decoration-none" data-bs-toggle="tooltip" data-bs-title="{PHP.L.footer_cotonti_tooltip}">
              ...
              <img src="{PHP.cfg.mainurl}/{PHP.cfg.themes_dir}/{PHP.cfg.defaulttheme}/img/favicon-small.webp" width="27" height="27" alt="Cotonti CMF">
	...
	<!-- IF {PHP.usr.id} == 0 -->
	{FILE "{PHP.cfg.themes_dir}/{PHP.cfg.defaulttheme}/inc/footer/guestMenu.tpl"}
    <!-- ENDIF -->
{FOOTER_RC}
</body>
</html>
