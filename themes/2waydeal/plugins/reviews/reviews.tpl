...
<div class="my-4">
    ...
    <div class="row mb-3 border-bottom pb-3 align-items-start">
        <div class="col-12 col-md-2 text-center">
                            ...
                            <img src="{REVIEW_ROW_AVATAR_SRC}" alt="{REVIEW_ROW_NICKNAME}" class="rounded-circle img-fluid" width="76" height="76">
                            <!-- ELSE -->
                            <img src="{PHP.R.userimg_default_avatar}" alt="{REVIEW_ROW_NICKNAME}" class="rounded-circle img-fluid" width="76" height="76">
                            <!-- ENDIF -->
                            <!-- ENDIF -->
