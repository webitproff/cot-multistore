...
if ($a == 'update') {
	...
	if ($ritemdelete) {
		$resultOrMessage = cot_mstore_delete($id, $row_item);
...
$item['msitem_status'] = cot_mstore_status($item['msitem_state'], $item['msitem_begin'], $item['msitem_expire']);
...
$itemedit_array = [
	...
	'MSTOREEDIT_FORM_KEYWORDS' => cot_inputbox('text', 'rmsitemkeywords', $item['msitem_keywords'], array('maxlength' => '255')),
	...
	'MSTOREEDIT_FORM_AUTHOR' => cot_inputbox('text', 'rmsitemauthor', $item['msitem_author'], array('maxlength' => '100')),
	...
	'MSTOREEDIT_FORM_BEGIN' => cot_selectbox_date($item['msitem_begin'], 'long', 'rmsitembegin').' '.Cot::$usr['timetext'],
	'MSTOREEDIT_FORM_EXPIRE' => cot_selectbox_date($item['msitem_expire'], 'long', 'rmsitemexpire').' '.Cot::$usr['timetext'],
	'MSTOREEDIT_FORM_UPDATED' => cot_date('datetime_full', $item['msitem_updated']).' '.Cot::$usr['timetext'],
	'MSTOREEDIT_FORM_FILE' => cot_selectbox(
        $item['msitem_file'],
        'rmsitemfile',
        range(0, 2),
	...
	'MSTOREEDIT_FORM_URL' => cot_inputbox('text', 'rmsitemurl', $item['msitem_url'], ['maxlength' => '255']),
	'MSTOREEDIT_FORM_SIZE' => cot_inputbox('text', 'rmsitemsize', $item['msitem_size'], ['maxlength' => '255']),
...
if (Cot::$usr['isadmin']) {
	$itemedit_array += [
		...
		'MSTOREEDIT_FORM_FILE_DOWNLOADS' => cot_inputbox('text', 'rmsitemfilecount', $item['msitem_filecount'], ['maxlength' => '8']),
	];
}
