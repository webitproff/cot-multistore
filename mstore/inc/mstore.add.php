...
$itemadd_array = [
	...
	'MSTOREADD_FORM_KEYWORDS' => cot_inputbox('text', 'rmsitemkeywords', $ritem['msitem_keywords'], ['maxlength' => '255']),
	...
	'MSTOREADD_FORM_AUTHOR' => cot_inputbox('text', 'rmsitemauthor', $ritem['msitem_author'], ['maxlength' => '100']),
	...
	'MSTOREADD_FORM_BEGIN' => cot_selectbox_date(Cot::$sys['now'], 'long', 'rmsitembegin'),
	'MSTOREADD_FORM_EXPIRE' => cot_selectbox_date(0, 'long', 'rmsitemexpire'),
	'MSTOREADD_FORM_FILE' => cot_selectbox(
        $ritem['msitem_file'],
        'rmsitemfile',
        range(0, 2),
	...
	'MSTOREADD_FORM_URL' => cot_inputbox('text', 'rmsitemurl', $ritem['msitem_url'], ['maxlength' => '255']),
	'MSTOREADD_FORM_SIZE' => cot_inputbox('text', 'rmsitemsize', $ritem['msitem_size'], ['maxlength' => '255']),
