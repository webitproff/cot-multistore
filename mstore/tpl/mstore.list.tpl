    ...
    <div class="col-12 col-xxl-11">
	  ...
	  <div class="col-12">
        <div class="row align-items-center mb-2">
          ...
          <div class="col-md-4 col-lg-3 col-12 d-flex justify-content-center justify-content-md-end mt-3 mt-md-0"> {LIST_SUBMIT_NEW_ITEM} </div>
          <!-- ENDIF -->
        </div>
            ...
            <div class="row g-0 align-items-stretch">
              ...
              <div class="col-md-7 col-lg-8">
                <div class="card position-relative h-100 border-0">
                  ...
                  <div class="card-body border-top d-flex flex-column justify-content-center"> {LIST_ROW_FILTER_PARAMS_HTML}
