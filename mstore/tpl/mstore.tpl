...
<div class="border-bottom border-secondary py-3 px-3">
  <nav aria-label="breadcrumb">
    <div class="ps-container-breadcrumb">
      <ol class="breadcrumb d-flex mb-0">{MSTORE_BREADCRUMBS}</ol>
    </div>
  </nav>
</div>
    ...
    <div class="col-12 container-3xl"> 
      ...
      <div class="row align-items-center mb-4">
        ...
        <div class="col-md-4 col-lg-3 col-12 d-flex justify-content-center justify-content-md-end mt-3 mt-md-0">
          <a class="btn btn-outline-secondary" href="{PHP|cot_url('mstore', 'm=add', '&c={PHP.c}')}">{PHP.L.mstore_addtitle}</a>
        </div>
        <!-- ENDIF -->
      </div>
      ...
      <div class="row pt-5">
        <div class="col-12 col-md-8 mx-auto pb-5">
          ...
          <!-- BEGIN: MEMBERSONLY -->
          <div class="mb-4">
            <p>{MSTORE_FILETITLE}</p>
          </div>
          <!-- END: MEMBERSONLY -->
          <!-- BEGIN: DOWNLOAD -->
          <div class="mb-4">
            <p class="small">{PHP.L.2wd_mstore_HasAttachment}</p>
            <p class="small">
              <a href="{MSTORE_FILE_URL}" class="btn btn-info btn-sm me-2" data-bs-toggle="tooltip" data-bs-title="{MSTORE_FILE_NAME}">{PHP.L.2wd_mstore_DownloadFile}</a>
            </p>
            <p class="small">{PHP.L.Downloaded}: {MSTORE_FILE_COUNTTIMES}</p>
          </div>
          <!-- END: DOWNLOAD -->
          <!-- ENDIF -->
          <!-- END: MSTORE_FILE -->
