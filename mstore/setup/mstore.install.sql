...
-- Sample store item
INSERT INTO `cot_mstore` (`msitem_state`, `msitem_cat`, `msitem_title`, `msitem_desc`, `msitem_text`, `msitem_author`, `msitem_ownerid`, `msitem_date`, `msitem_begin`, `msitem_expire`, `msitem_file`, `msitem_url`, `msitem_size`, `msitem_count`, `msitem_filecount`, `msitem_alias`) VALUES
(0, 'tricycle', 'Crosser TR7 Tricycle', 'Stable and modern electric tricycle', 'The Crosser TR7 electric tricycle is an excellent choice for those seeking stability, safety, and modern design for urban or suburban routes. This electric trike is designed with a focus on comfort and confidence while driving. Thanks to modern technologies and reliable components, the TR7 combines the best qualities of a scooter, moped, and convenient everyday transport.', '', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, '', 0, 0, 0, '');