/**
 * Mstore module DB installation
 */

-- Default categories permissions
...
CREATE TABLE IF NOT EXISTS `cot_mstore` (
  ...
  `msitem_keywords` varchar(255) DEFAULT '',
  `msitem_metatitle` varchar(255) DEFAULT '',
  `msitem_metadesc` varchar(255) DEFAULT '',
  `msitem_text` MEDIUMTEXT DEFAULT NULL,
  `msitem_price_opt` decimal(10,2) NOT NULL DEFAULT '0.00',
  `msitem_price_drop` decimal(10,2) NOT NULL DEFAULT '0.00',
  `msitem_price_rr` decimal(10,2) NOT NULL DEFAULT '0.00',
  `msitem_parser` varchar(64) DEFAULT '',
  `msitem_author` varchar(100) DEFAULT '',
  `msitem_ownerid` int UNSIGNED NOT NULL DEFAULT '0',
  `msitem_date` int UNSIGNED NOT NULL DEFAULT '0',
  `msitem_begin` int UNSIGNED NOT NULL DEFAULT '0',
  `msitem_expire` int UNSIGNED NOT NULL DEFAULT '0',
  `msitem_updated` int UNSIGNED NOT NULL DEFAULT '0',
  `msitem_main_image_url` varchar(255) DEFAULT '',
  `msitem_file` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `msitem_url` varchar(255) DEFAULT '',
  `msitem_size` int UNSIGNED NOT NULL DEFAULT '0',
  `msitem_count` mediumint UNSIGNED NOT NULL DEFAULT '0',
  `msitem_filecount` mediumint UNSIGNED NOT NULL DEFAULT '0',
  ...
  KEY `msitem_begin` (`msitem_begin`),
  KEY `msitem_expire` (`msitem_expire`),
...
-- Sample store item
INSERT INTO `cot_mstore` (`msitem_state`, `msitem_cat`, `msitem_title`, `msitem_desc`, `msitem_text`, `msitem_price_opt`, `msitem_price_drop`, `msitem_price_rr`, `msitem_author`, `msitem_ownerid`, `msitem_date`, `msitem_begin`, `msitem_expire`, `msitem_file`, `msitem_url`, `msitem_size`, `msitem_count`, `msitem_filecount`, `msitem_alias`) VALUES
(0, 'tricycle', 'Crosser TR7 Tricycle', 'Stable and modern electric tricycle', 'The Crosser TR7 electric tricycle is an excellent choice for those seeking stability, safety, and modern design for urban or suburban routes. This electric trike is designed with a focus on comfort and confidence while driving. Thanks to modern technologies and reliable components, the TR7 combines the best qualities of a scooter, moped, and convenient everyday transport.', '0.00', '0.00', '0.00', '', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 0, 0, '', 0, 0, 0, '');